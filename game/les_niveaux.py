...
NIVEAUX = [
    ...
    dict(
        ...
        aide="Des que tu tentes de mourir, il surgit sur toi et te recoud. Endors-le avec les somniferes (au-dessus de lui), puis file te tuer avant qu il ne se releve.",
