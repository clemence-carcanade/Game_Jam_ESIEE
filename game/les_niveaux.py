...
NIVEAUX = [
    ...
    dict(
        ...
        pousseurs=[
            ...
            # la nuee : une foule de chats qui bousculent, force plus douce
            dict(min=(60, 830), max=(520, 830), vitesse=2.0, force=9),
            dict(min=(620, 830), max=(1080, 830), vitesse=2.28, force=11),
            dict(min=(1150, 830), max=(1500, 830), vitesse=2.56, force=13),
            dict(min=(1520, 830), max=(1720, 830), vitesse=2.84, force=15),
            dict(min=(60, 600), max=(470, 600), vitesse=3.12, force=9),
            dict(min=(560, 600), max=(1040, 600), vitesse=2.0, force=11),
            dict(min=(1120, 600), max=(1500, 600), vitesse=2.28, force=13),
            dict(min=(1520, 600), max=(1720, 600), vitesse=2.56, force=15),
            dict(min=(60, 300), max=(500, 300), vitesse=2.84, force=9),
            dict(min=(620, 300), max=(1080, 300), vitesse=3.12, force=11),
            dict(min=(1160, 300), max=(1500, 300), vitesse=2.0, force=13),
            dict(min=(1520, 300), max=(1700, 300), vitesse=2.28, force=15),
            dict(min=(130, 380), max=(300, 380), vitesse=2.56, force=9),
            dict(min=(560, 380), max=(760, 380), vitesse=2.84, force=11),
            dict(min=(700, 250), max=(900, 250), vitesse=3.12, force=13),
            dict(min=(900, 480), max=(1120, 480), vitesse=2.0, force=15),
            dict(min=(1180, 380), max=(1400, 380), vitesse=2.28, force=9),
            dict(min=(620, 620), max=(820, 620), vitesse=2.56, force=11),
            dict(min=(1200, 700), max=(1420, 700), vitesse=2.84, force=13),
            dict(min=(1480, 480), max=(1680, 480), vitesse=3.12, force=15),
            dict(min=(300, 620), max=(480, 620), vitesse=2.0, force=9),
        ],
        faux_pieges={
