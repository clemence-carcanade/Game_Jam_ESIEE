...
NIVEAUX = [
    ...
    dict(
        ...
        aide="Fais tomber la cloche du diner dans la gamelle commune. Puis tiens-toi pret.",
        message_piege="La cloche du diner resonne dans toute la demeure. Cent chats levent la tete.",
        message_mort="Englouti sous cent chats affames. Il n en restait rien.",
        message_attente="La cloche est encore la-haut. Fais-la tomber dans la gamelle.",
        depart="salon",
        pousseurs=[
        ...
        objet="arbre_haut", pousse="g", objet_image="cloche",
        piege="chatterie", piege_largeur=140, horde=True,
        faux_pieges={
