...
NIVEAUX = [
    ...
    dict(
        titre="La vieille demeure : cent chats et une fiole", maitre="la vieille",
        famille='La vieille aux cent chats', probleme='Cent chats, une seule gamelle, rien a soi',
        aide="Une fiole de mort-au-rat t attend tout en haut. Rejoins-la malgre la nuee, et bois (E).",
        message_piege="",
        message_mort="La mort-au-rat fait son effet. Une vie s en va, doucement.",
        message_attente="",
        depart="salon",
        # la vieille est deja peinte sur le fond : pas de sprite
        chat_noir="paniere",
        pousseurs=[
        ...
        faux_pieges={
            ...
            "v": dict(pos="cuisine", declenchement="action", image="aucune",
                      texte="La charentaise s abat sur lui. Epaisse comme un matelas. Rien."),
            "l": dict(pos="chambre", declenchement="action", effet="soin", image="aucune",
            ...
            "b": dict(pos="salle_droite", declenchement="action", image="aucune",
    ...
    dict(
        ...
        faux_pieges={
            "e": dict(pos="chambre", declenchement="contact", recharge=9.0,
                      effet="projection", vitesse=(4, 19), image="aucune",
            ...
            "l": dict(pos="lit", declenchement="contact", recharge=8.0, image="aucune",
