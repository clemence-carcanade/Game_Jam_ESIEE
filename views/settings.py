...
# Commenté car le module audio n'est pas encore relié :
...
class SettingsView(arcade.View):
    ...
    def __init__(self):
        ...
        # Variable temporaire pour simuler le volume (de 0.0 à 1.0)
        self.volume = 0.5
    ...
    def _update_volume_from_mouse(self, x: float):
        ...
        # _audio.regler_volume(self.volume) # Décommenter quand le son sera lié
